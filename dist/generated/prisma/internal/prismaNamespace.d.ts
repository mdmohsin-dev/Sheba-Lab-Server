...
export declare const ModelName: {
    ...
    readonly PatientHealthData: "PatientHealthData";
    readonly MedicalReport: "MedicalReport";
    readonly Schedule: "Schedule";
    readonly DoctorSchedules: "DoctorSchedules";
    readonly Specialties: "Specialties";
    readonly DoctorSpecialties: "DoctorSpecialties";
    readonly User: "User";
...
export declare const AppointmentScalarFieldEnum: {
    ...
    readonly videoCallingId: "videoCallingId";
...
export declare const PatientHealthDataScalarFieldEnum: {
    readonly id: "id";
    readonly patientId: "patientId";
    readonly gender: "gender";
    readonly dateOfBirth: "dateOfBirth";
    readonly bloodGroup: "bloodGroup";
    readonly hasAllergies: "hasAllergies";
    readonly hasDiabetes: "hasDiabetes";
    readonly height: "height";
    readonly weight: "weight";
    readonly smokingStatus: "smokingStatus";
    readonly dietaryPreferences: "dietaryPreferences";
    readonly pregnancyStatus: "pregnancyStatus";
    readonly mentalHealthHistory: "mentalHealthHistory";
    readonly immunizationStatus: "immunizationStatus";
    readonly hasPastSurgeries: "hasPastSurgeries";
    readonly recentAnxiety: "recentAnxiety";
    readonly recentDepression: "recentDepression";
...
export declare const MedicalReportScalarFieldEnum: {
    ...
    readonly reportLink: "reportLink";
    readonly createdAt: "createdAt";
    readonly updatedAt: "updatedAt";
};
...
export declare const DoctorSchedulesScalarFieldEnum: {
    readonly doctorId: "doctorId";
    readonly scheduleId: "scheduleId";
...
export declare const SpecialtiesScalarFieldEnum: {
    readonly id: "id";
    readonly title: "title";
    readonly icon: "icon";
};
export type SpecialtiesScalarFieldEnum = (typeof SpecialtiesScalarFieldEnum)[keyof typeof SpecialtiesScalarFieldEnum];
export declare const DoctorSpecialtiesScalarFieldEnum: {
    readonly specialitiesId: "specialitiesId";
    readonly doctorId: "doctorId";
};
